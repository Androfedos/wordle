...
class MyWidget(QMainWindow):
    def __init__(self):
        ...
        self.step = 0
        spisok = ["ангел", "понос","лодка","остов","кошка","химия","физик","совет","свеча","поток","пенал", "ножны","бобёр","живот","ложка","отдел","право","устой","обувь", "будка", "мышка", "ягуар", "столб", "вилка", "класс", "слуга", "осётр", "лимон"]
